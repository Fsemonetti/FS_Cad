...
type
  ...
  TDimensionamento = Class(MinhaClasse)
   ...
   property Permitir_Forca_E_Iluminacao_Mesmo_Condutor : Booelan read FPermitir_Forca_E_Iluminacao_Mesmo_Condutor write SetPermitir_Forca_E_Iluminacao_Mesmo_Condutor;
   property Permitir_LAmpada_Sem_Interruptor : Booelan read FPermitir_LAmpada_Sem_Interruptor write SetPermitir_LAmpada_Sem_Interruptor;
   property Ignorar_Fator_De_Agrupamento : Boolean read FIgnorar_Fator_De_Agrupamento write SetIgnorar_Fator_De_Agrupamento;
   property Adotar_Maior_Disjuntor_Da_Faixa : Booelan read FAdotar_Maior_Disjuntor_Da_Faixa write SetAdotar_Maior_Disjuntor_Da_Faixa;
...
procedure TDimensionamento.SetAdotar_Maior_Disjuntor_Da_Faixa(AValue: Booelan);
begin
...
procedure TDimensionamento.SetPermitir_LAmpada_Sem_Interruptor(AValue: Booelan);
begin
